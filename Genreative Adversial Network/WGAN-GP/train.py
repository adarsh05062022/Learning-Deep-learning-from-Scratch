...
image_dir = "/data1/adarsh/MODEL_TRAINING/GAN/WGAN_GP/generated_images"
checkpoint_dir = "/data1/adarsh/MODEL_TRAINING/GAN/WGAN_GP/checkpoints"
...
def train():
    ...
    for epoch in range(start_epoch,NUM_EPOCHS):
        for batch_index , real in enumerate(dataloader):
            real = real.to(device)
